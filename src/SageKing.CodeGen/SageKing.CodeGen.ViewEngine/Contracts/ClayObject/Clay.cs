using SageKing.CodeGen.SageKingViewEngine.ClayObject.Extensions;
...
namespace SageKing.CodeGen.SageKingViewEngine.ClayObject;
...
public sealed class Clay : DynamicObject, IEnumerable
{
    ...
    {
        return ToString().JsonTo<T>(jsonSerializerOptions);
    }
    ...
    private static dynamic DeserializeValue(XElement element, Type elementType, bool throwOnUndefined = true)
    {
        ...
        return value.ChangeType(elementType);
    }
