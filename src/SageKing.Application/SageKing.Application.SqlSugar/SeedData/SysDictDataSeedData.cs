...
public class SysDictDataSeedData : ISqlSugarEntitySeedData<SysDictData>
{
    ...
    public IEnumerable<SysDictData> HasData()
    {
        ...
        return new[]
        {
            new SysDictData{ Id=crrrStarId, DictTypeId=crrrStarDictTypeId, Code="DB表类", ValueInt=1, OrderNo=100, Remark="" },
            new SysDictData{ Id=crrrStarId+1, DictTypeId=crrrStarDictTypeId, Code="业务类", ValueInt=2, OrderNo=100, Remark="" },
            new SysDictData{ Id=crrrStarId+3, DictTypeId=crrrStarDictTypeId, Code="通知类", ValueInt=3, OrderNo=100, Remark="" },
