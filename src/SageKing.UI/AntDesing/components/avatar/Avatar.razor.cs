...
namespace AntDesign
{
    public partial class Avatar : AntDomComponentBase
    {
        ...
        [Parameter]
        public EventCallback<Microsoft.AspNetCore.Components.Web.ErrorEventArgs> OnError { get; set; }
        ...
        private async Task ImgError(Microsoft.AspNetCore.Components.Web.ErrorEventArgs args)
        {
